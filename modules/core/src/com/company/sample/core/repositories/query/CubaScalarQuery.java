...
public class CubaScalarQuery extends CubaAbstractQuery {

    private static final Log log = LogFactory.getLog(CubaScalarQuery.class.getName());

    public CubaScalarQuery(Method method, RepositoryMetadata metadata, ProjectionFactory factory, PartTree qryTree) {
